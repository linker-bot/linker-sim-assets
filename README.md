...
- the asset tree at [`src/linker_robot_assets/assets/`](src/linker_robot_assets/assets/) — URDF / MJCF + meshes, organised by `components/` and `workstations/` (binaries are stored via git LFS);
